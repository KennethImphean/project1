...
```{R eval=F}
library(tidyverse)
data1 <- read_csv("/path/to/Data from County Health Rankings and Biostats project.csv")
data2 <- read_csv("/path/to/COVID-19 Vaccine Data by County.csv")

#or, if you'd prefer to read it in from some remote location

data1 <- read_csv("https://healthdata.gov/api/views/anag-cw7u/rows.csv?accessType=DOWNLOAD")
data2 <- read_csv("https://data.cdc.gov/api/views/8xkx-amqh/rows.csv?accessType=DOWNLOAD")
```
